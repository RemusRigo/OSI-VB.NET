Module Common
   ...
   '-----------------------------------------------------------------------------------------------
   ' GetWMIAvailability
   Public Function GetWMIBatteryStatus(code As Integer) As String
      Select Case code
         Case 1 : Return "Other"
         Case 2 : Return "Unknown"
         ...
         Case Else : Return $"Not defined / code ({code})"
      End Select
   End Function

   Public Function GetWMIBIOSCharacteristic(code As UInt16) As String
      Select Case code
   ...
   Public Function GetWMIConfigManagerErrorCode(code As Integer) As String
      Select Case code
